...
(* OASIS_START *)
(* DO NOT EDIT (digest: 20b4f68e4b8a7798f3f7936b81a54ab2) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Merge_queue"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "merge-queues";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "linear.ml"});
               Executable
                 ({
                     cs_name = "bench_branch";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "branch.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ZÄÎ\142ôñð\003Áy\016\148È&\005á";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
